                    ...
                    <div class="row g-3 align-items-center">
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select" name="name" aria-label="Default select example">
                                ...
                                <option value="Machines & Technology">Machines & Technology</option>
                                <option value="Customization & Engineering">Customization & Engineering</option>
                                <option value="Installation & Support">Installation & Support</option>
                                <option value="Quality, Safety & Compliance">Quality, Safety & Compliance</option>
