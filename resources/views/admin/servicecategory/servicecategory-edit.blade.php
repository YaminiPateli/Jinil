...
@section('title', 'servicecategory Edit')
...
<div class="container-xxl">
    ...
    <div class="row align-items-center">
        <div class="border-0 mb-4">
            <div
                ...
                <h3 class="fw-bold mb-0">servicecategory Edit</h3>
                <!--<button type="submit"-->
    ...
    <div class="card-body">
        <form method="post" enctype="multipart/form-data" action="{{ route('servicecategory.update',$servicecategory->id) }}">
            @csrf
            @method('PATCH')
                        ...
                        <div class="card-body">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" id="servicecategory" name="servicecategory" class="form-control"
                                    value="{{ $servicecategory->servicecategory }}" placeholder="servicecategory">
                            </div>
                            <div class="col-md-6">
                                <label class="form-label">URL</label>
                                <input type="text" id="url" name="url" class="form-control"
                                    value="{{ $servicecategory->url }}" placeholder="servicecategory URL">
                            </div>
                            <div class="col-md-6">
                                ...
                                <textarea id="cat_description" name="cat_description" class="form-control"
                                    placeholder="servicecategory Description">{{ $servicecategory->cat_description }}</textarea>
                            </div>
                            </div>
                        </div>
                    </div>
